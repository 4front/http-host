...
module.exports = function(settings) {
  ...
  router.use(timer.instrument(require('./middleware/app-loader')(settings)));
  ...
  router.use(timer.instrument(require('./middleware/traffic-control')(settings)));
