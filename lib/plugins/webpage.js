...
module.exports = function(options) {
  ...
  return function(req, res, next) {
    ...
    if (_.isFunction(req.ext.loadPageMiddleware)) {
      req.ext.loadPageMiddleware(req, res, function(err) {
        ...
        decorateEmitter(req.ext.webPageStream, req, res, next);
      ...
      req.ext.webPageStream = function(callback) {
        ...
        var streamEmitter = req.app.settings.storage.readFileStream(storagePath)
          .on('stream', function(readStream) {
            callback(null, readStream);
          });

        decorateEmitter(streamEmitter, req, res, next);
      };
  ...
  function decorateEmitter(emitter, req, res, next) {
