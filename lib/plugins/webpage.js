...
module.exports = function(options) {
  ...
  return function(req, res, next) {
    ...
    function streamResponse() {
      ...
      res.set('Virtual-App-Version-Name', req.ext.virtualAppVersion.versionId);
  ...
  function buildHtmlOptions(req, versionId, versionName) {
    ...
    if (htmlOptions.autoReload === true) {
      var autoReloadScript = "<script src='//localhost:" + req.ext.htmlOptions.sandboxPort + "/static/autoreload.js'></script>" +
        "<script>window.__autoReload = new AutoReload({port:" + req.ext.htmlOptions.sandboxPort + "});" +
