...
var loginFormEmbedScript = (function() {
  ...
  var embedScript = fs.readFileSync(__dirname + '/client-embed.js').toString();
...
module.exports = function(options) {
  ...
  return function(req, res, next) {
    ...
    req.ext.clientConfig.authBaseUrl = req.baseUrl;
