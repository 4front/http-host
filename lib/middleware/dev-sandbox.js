...
module.exports = function(options) {
  ...
  return function(req, res, next) {
    ...
    if (req.path === '/__login') {
      ...
      res.clearCookie(options.sandboxFlashCookie);
    ...
    var devOptions = _.extend(_.defaults({}, devCookie, defaultDevOptions), {
    ...
    // If this is a request for a static asset or an XHR request
    // for an .html file, redirect back to localhost.
    ...
    req.app.settings.cache.get(req.ext.developerId + '/' + req.ext.virtualApp.appId + '/_manifest', function(err, manifestJson) {
