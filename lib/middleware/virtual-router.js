...
module.exports = function(options) {
  ...
  function middlewareFn(routeInfo) {
    return function(req, res, next) {
      ...
      // Also allow other addons to be passed as options??
      var moduleRequirePath;
      if (routeInfo.module.slice(0, 6) === 'addon:') {
        moduleRequirePath = path.join(req.app.settings.addonsDir, "node_modules", routeInfo.module.slice(6));
      }
      else {
