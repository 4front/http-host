...
module.exports = function(options) {
  ...
  return function(req, res) {
    ...
    if (_.isFunction(req.ext.webPageStream)) {
      req.ext.webPageStream = req.ext.webPageStream();
    }
  ...
  function generateETag(req) {
    ...
    if (req.ext.user || req.ext.virtualEnv === 'dev') return null;
  ...
  function buildHtmlOptions(req, versionId, versionName) {
    ...
    if (_.isString(req.app.settings.clientConfigVar) && req.app.settings.clientConfigVar !== options.clientConfigVar) {
