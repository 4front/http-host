...
module.exports = function(options) {
  ...
  function populateClientConfig(req, res, versionId, versionName) {
    ...
    // Calculate a hash of the stringified manifest. This value will change
    // if the manifest changes or if the value of an environment variable
    // referred to in the manifest changes. It is passed along in the fingerprint
    // option of htmlprep.
    var manifestSha = sha1(JSON.stringify(req.ext.virtualAppVersion.manifest || {}));
