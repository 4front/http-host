...
module.exports = function(options) {
  ...
  function possibleAlternateFiles(req) {
    ...
    if (req.originalUrl.slice(-1) === '/') {
      ...
      // Could potentially look for additional file extensions for requests like https://site.com/feed
      // alternates.push({url: req.originalUrl + '.json', code: 302});
      // alternates.push({url: req.originalUrl + '.xml', code: 302});
    }
