...
exports = module.exports = function(options) {
  ...
  return function(req, res, next) {
    ...
    if (req.ext.virtualHost.indexOf(req.app.settings.virtualHost) === -1) {
      ...
      req.app.settings.virtualAppRegistry.findByDomain(req.ext.virtualHost, findAppCallback);
    }
    else {
      ...
      req.app.settings.virtualAppRegistry.findByName(appName, findAppCallback);
    }
