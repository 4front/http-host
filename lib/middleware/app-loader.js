...
exports = module.exports = function(settings) {
  return function(req, res, next) {
    ...
    loadFunc(req, function(err, virtualApp) {
      ...
      if (!virtualApp) {
        if (isCustomDomain) {
          return lookForCatchAllRedirect(req, res, next);
        }
        return appNotFound(req, res, next);
      }
  ...
  function lookForCatchAllRedirect(req, res, next) {
    ...
    req.app.settings.database.getDomain(req.ext.domainName, function(err, domain) {
