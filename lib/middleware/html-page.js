...
module.exports = function(options) {
  ...
  return function(req, res, next) {
    ...
    // Allow an alternative assetStorage to be specified on the extended request
    // that overrides the default. This is how the dev-sandbox intercepts the
    // loading of html pages from cache rather than the true storage.
    ...
    if (_.isFunction(req.ext.createReadStream)) {
      ...
      streamResponse(assetStorage.createReadStream(
