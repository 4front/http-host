...
module.exports = function(options) {
  ...
  return function(req, res, next) {
    ...
    _.assign(req.ext, {
      ...
      contentType: mime.lookup(reqPath)
    });
    ...
    // support gzip.
    if (!acceptsGzip || req.ext.extName === '.xml') {
